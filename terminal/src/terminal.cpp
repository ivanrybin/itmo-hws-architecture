 ...
 *  Инициализуерт поля, отвечающие за работу CLI.
 */
...
/*
 *  Метод terminal::run запускает CLI.
 */
...
/*
 *  Метод terminal::merge_env сливает окружение сабтерминалов с основным.
 */
...
/*
 * Метод terminal::execute_commands отвечает за запуск команд, поддерживаемых CLI
 * после этапа парсинга входной строки.
 */
...
/*
 * Метод terminal::get_input_from_terminal отвечает за получение пользовательского вода из консоли,
 * включая обработку ввод через кавычки.
 */
...
/*
 * Метод terminal::parse разбирает строку полученную в terminal::get_input_from_terminal.
 */
...
/*
 * Метод terminal::parse_vars разбирает и осуществляет подстановку переменных в строку.
 */
...
/*
 * Метод terminal::parse_vars разбирает строку на токены.
 */
...
/*
 * Метод terminal::parse_dollars обработчик замены переменных через $ на их значение.
 */
...
/*
 *  Метод terminal::go_spaces пропускает лишние пробелы при парсинге строки, смещая текущий индекс.
 */
...
/*
 *  Метод terminal::quote_handler обеспечивает обработку ввод вместе с кавычками.
 */
...
/*
 *  Метод terminal::command_not_found_exc отвечает за выброс исключения о несуществующей команде.
 */
